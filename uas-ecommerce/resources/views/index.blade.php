...
<body id="page-top">
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand" href="#page-top">
                <h4 class="text-white fw-bold">Shoes Store</h4>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                    ...
                    <li class="nav-item"><a class="nav-link text-white fw-bold" href="#fitur">Fitures</a></li>
    ...
    <header class="masthead" id="home">
        <div class="container">
            <div class="masthead-subheading text-info fw-bolder">Shoes Store</div>
    ...
    <section class="page-section" id="fitur">
        <div class="container">
            <div class="text-center">
                <h2 class="section-heading text-uppercase">Fitures</h2>
                        ...
                        <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" data-bs-target="#portfolioModal"
                                ...
                                <div class="d-flex justify-content-center">
                                    <img class="img-fluid w-50" src="assets/img/product.jpg" alt="..." />
                                    <img class="img-fluid w-50" src="assets/img/product.jpg" alt="..." />
                                </div>
    ...
    <section class="page-section" id="about">
        <div class="container">
            <div class="text-center">
                <h3 class="display-5 fw-bolder py-2">Shoes Store</h3>
                <p id="about" class="lead py-2 fw-normal text-dark-50 mb-0">Toko sepatu adalah sebuah tempat di
                    mana Anda dapat membeli berbagai macam sepatu untuk berbagai kebutuhan dan gaya. Toko sepatu
                    biasanya menyediakan berbagai merek, model, dan ukuran sepatu untuk pria, wanita, dan anak-anak.
                    Toko sepatu juga dapat menawarkan aksesori sepatu seperti kaos kaki, pelindung sepatu, dan produk
                    perawatan sepatu. </p>
            </div>
        </div>
    </section>
    ...
    <footer class="footer bg-dark text-white py-4">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-4 text-lg-start fw-bold fs-6">Shoes Store</div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="modal-body">
                                ...
                                <img class="img-fluid w-75 d-block mx-auto" src="assets/img/product.jpg"
                                    alt="modal" />
